...

{
    ...
    if ( match(memoLigne, "#") && match(memoLigne, "else|endif") ) 
			if ( !match($0, "//"))
				reportBug("5.2 #PREPROC else COMMENT", NR-1, memoLigne)
	...
	if ( int(start/4) != (start/4) && start != -1) 
			reportBug("6.4 INDENT 4 MULTIPLE", NR, $0 )

			
#	if ( match ($0, lst0702)) 
#			reportBug("7.2 * MUST NEXT VARIABLE,", NR, $0 )


				
#7.2 7.4 7.7 7.8 7.12 7.16 7.18 7.19 7.21 7.28 8.10
